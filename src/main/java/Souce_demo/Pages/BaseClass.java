...
public class BaseClass {
    ...
    public static Properties propertiesPath;
    protected static PageFactory pageFactory;

    public BaseClass() {
        try {
            propertiesPath = new Properties();
            FileInputStream input = new FileInputStream(System.getProperty("user.dir") + "//src//main//java//Souce_demo//PropertiesFiles//Config.properties");
